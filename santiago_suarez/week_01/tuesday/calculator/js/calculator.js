...
var areaOfCircle = function(radius) {
  var res = Math.round(Math.PI * Math.pow(radius, 2) * 100)/100;
  console.log("The area for a circle with radius " + radius + " is " + res);
  return res;
}

var mystery = function(num) {
  var first = halfNumber(num);
  var second = squareNumber(first);
  var third = areaOfCircle(second);
  var fourth = percentOf(third, second);
  console.log(fourth);
  return fourth;
}
